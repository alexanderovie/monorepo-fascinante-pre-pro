  ...
  <main id="content">
    <div class="py-10 lg:pb-20">
      ...
      <div class="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
        <!-- Grid -->
        <div class="flex flex-col lg:flex-row lg:justify-between gap-y-5 gap-x-10">
          <!-- Left Sidebar -->
          <div class="lg:w-48">
            <div class="lg:sticky lg:top-20">
              <a class="pe-3 group inline-flex items-center gap-x-2 text-start whitespace-nowrap text-sm text-gray-800 rounded-full underline-offset-2 hover:underline hover:decoration-2 focus:outline-hidden focus:underline focus:decoration-2 dark:text-neutral-300" href="/">
                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="lg:max-w-xl w-full">
            <!-- Heading -->
            <div class="pb-6 mb-6 lg:pb-10 lg:mb-10 lg:last:pb-0 last:mb-0 lg:last:border-b-0 border-b border-gray-200 dark:border-neutral-700">
              ...
              <h1 class="font-semibold text-2xl lg:text-3xl text-gray-800 dark:text-neutral-200">
                Rise in E-commerce
              </h1>
              ...
              <div class="mt-8">
                ...
                <div class="mt-3 flex flex-wrap gap-y-4 gap-x-10">
                  <!-- Avatar Media -->
                  <div class="flex items-center gap-x-3">
                    <img class="shrink-0 size-9 rounded-full grayscale" src="https://images.unsplash.com/photo-1720048169575-b179e1a20dc2?q=80&w=160&h=160&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Avatar">
                    <div class="grow">
                  ...
                  <!-- Avatar Media -->
                  <div class="flex items-center gap-x-3">
                    <img class="shrink-0 size-9 rounded-full grayscale" src="https://images.unsplash.com/photo-1721333087252-e4cffc249d2d?q=80&w=160&h=160&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Avatar">
                    <div class="grow">
                      <span class="block font-medium text-sm text-gray-800 dark:text-neutral-200">
                        Thomas Moor
                      </span>
            ...
            <div class="space-y-7 pb-6 mb-6 lg:pb-10 lg:mb-10 lg:last:pb-0 last:mb-0 lg:last:border-b-0 border-b border-gray-200 dark:border-neutral-700">
              <p class="text-gray-600 dark:text-neutral-400">
                When Shopify's engineering team faced the challenge of scaling their development workflows across thousands of developers, they turned to Preline to streamline their UI component system. The results? A 40% reduction in development time and unprecedented consistency across their vast ecosystem of merchant-facing applications.
              </p>
              ...
              <p class="text-gray-600 dark:text-neutral-400">
                As one of the world's leading e-commerce platforms, Shopify's engineering team manages hundreds of applications that serve millions of merchants globally. With their rapid growth came increasing complexity:
              </p>

              <ul class="flex flex-col gap-y-1 text-gray-600 dark:text-neutral-400">
                <li class="flex gap-x-3">
                  <div class="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                  Inconsistent UI components across different teams and applications
                </li>
                <li class="flex gap-x-3">
                  <div class="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                ...
                <li class="flex gap-x-3">
                  <div class="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                  Growing technical debt from duplicate component implementations
                </li>
              </ul>

              <p class="text-gray-600 dark:text-neutral-400">
                "Before Preline, each team was essentially rebuilding the same components with slight variations. It was becoming unsustainable," explains Sarah Chen, Senior Engineering Manager at Shopify.
              </p>
              ...
              <ul class="flex flex-col gap-y-1 text-gray-600 dark:text-neutral-400">
                ...
                <li class="flex gap-x-3">
                  <div class="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                  Establishing new development workflows around Preline's tools
                </li>
                <li class="flex gap-x-3">
                  <div class="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                  Creating custom plugins to integrate with Shopify's internal tools
                </li>
              </ul>
              ...
              <p class="text-gray-600 dark:text-neutral-400">
                Shopify implemented Preline's component library and development toolkit across their entire organization. The implementation process included:
              </p>
              ...
              <ul class="flex flex-col gap-y-1 text-gray-600 dark:text-neutral-400">
                <li class="flex gap-x-3">
                  <div class="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                  <div>
                    <span class="font-medium text-gray-800 dark:text-neutral-200">40% Faster Development: </span>
                ...
                <li class="flex gap-x-3">
                  <div class="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                  <div>
                    <span class="font-medium text-gray-800 dark:text-neutral-200">90% Component Reuse: </span>
                ...
                <li class="flex gap-x-3">
                  <div class="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                  <div>
                    <span class="font-medium text-gray-800 dark:text-neutral-200">30% Fewer Bugs: </span>
                    Standardized components led to more reliable applications
                  </div>
                </li>
                <li class="flex gap-x-3">
                  <div class="shrink-0 size-2 mt-2 bg-gray-300 rounded-sm dark:bg-neutral-600"></div>
                  <div>
                    <span class="font-medium text-gray-800 dark:text-neutral-200">100% Design Compliance: </span>
              ...
              <p class="text-gray-600 dark:text-neutral-400">
                "Preline hasn't just given us a component library – it's given us a new way of thinking about development," says Michael Rodriguez, Director of Frontend Engineering. "Our teams can focus&nbsp;on solving merchant problems instead of rebuilding basic UI elements."
              </p>
              ...
              <p class="text-gray-600 dark:text-neutral-400">
                Following their successful implementation, Shopify is now exploring advanced Preline features to further optimize their development pipeline. They're working closely with the Preline team to develop new capabilities that will benefit both organizations.
              </p>

              <p class="text-gray-600 dark:text-neutral-400">
                "The partnership with Preline has been transformative," concludes Chen. "We're seeing benefits we didn't even anticipate when we started this journey."
              </p>
            </div>

            <div class="mb-5">
              <h4 class="font-semibold text-lg lg:text-xl text-gray-800 dark:text-neutral-200">
                More stories
              </h4>
            </div>
            ...
            <div class="space-y-5">
              <!-- Card -->
              <a class="group  flex flex-col bg-white focus:outline-hidden rounded-xl transition duration-200 dark:bg-neutral-900" href="/customer-details">
          ...
          <!-- Right Sidebar -->
          <div class="lg:max-w-3xs w-full lg:border-s border-gray-200 dark:border-neutral-700">
            <!-- Copany Info Card -->
            <div class="lg:sticky lg:top-20 lg:ps-10">
              <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-1 gap-5">
                <div>
                ...
                <div>
                  ...
                  <p class="mt-1 font-mono text-sm text-gray-600 dark:text-neutral-400">
                    E-commerce
                  </p>
                </div>
