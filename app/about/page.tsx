  ...
  <main id="content">
    ...
    <div class="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
      <div class="pt-10 md:pt-20 pb-14 md:pb-20">
        ...
        <div class="mb-10 max-w-xl mx-auto text-center">
          <h1 class="font-bold text-gray-800 text-4xl md:text-5xl dark:text-white">
            The story behind Preline
          </h1>

          <p class="mt-5 text-sm md:text-lg text-gray-800 dark:text-gray-200">
            Prelin is a web company that builds websites. Businesses of every size—from new startups to public companies—use our theme to build and manage their businesses online.
          </p>
        </div>
        <!-- End Heading -->

        <div class="w-full h-64 md:h-96 bg-gray-100 rounded-xl dark:bg-neutral-800">
          <img class="size-full object-cover rounded-xl dark:bg-neutral-800" src="https://images.unsplash.com/photo-1630569266941-f8a348786bf0?q=80&w=1920&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Hero Image">
        </div>
      </div>
    </div>
    <!-- End Hero -->
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-10">
        ...
        <div class="space-y-5">
          <p class="text-gray-500 dark:text-neutral-400">
            Preline is a powerful and versatile open-source library of prebuilt UI components based&nbsp;on the Tailwind CSS framework. With over 750 accessible and customizable components, templates, and examples, Preline empowers developers to create visually stunning and fully responsive, mobile-first websites with ease.
          </p>
          <p class="text-gray-500 dark:text-neutral-400">
            In addition to its robust component library, Preline offers a comprehensive Figma design system for seamless design-to-development workflows. Whether you're a developer or a designer, Preline provides the tools to streamline your projects and elevate your web creations.
          </p>
          <p class="text-gray-500 dark:text-neutral-400">
            Our offerings go beyond components—we specialize in custom web design and development services, including UI/UX design, starter templates, detailed documentation, and personalized support. Backed by a community-driven approach, Preline is here to help you build with confidence and creativity.
          </p>
        </div>
        <!-- End Col -->
      </div>
    ...
    <div class="py-14 lg:py-20">
      <div class="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <!-- Grid -->
        <div class="grid grid-cols-2 md:grid-cols-3 items-center gap-5 md:gap-y-10">
          <div>
            <p class="font-mono text-sm text-gray-500 dark:text-neutral-400">
              Monthly Page Views
            </p>
            <span class="block font-semibold text-xl sm:text-2xl text-gray-800 dark:text-neutral-200">
              70 million
            </span>
          </div>
          <!-- End Col -->
    ...
    <div class="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
      ...
      <div>
        ...
        <div class="group relative flex gap-x-3 sm:gap-x-5 md:gap-x-8">
          <!-- Left Side -->
          <div class="min-w-10 md:min-w-12">
            <h3 class="font-mono md:text-lg text-gray-800 dark:text-neutral-200">
              2020
            </h3>
          </div>
          <!-- End Left Side -->
          ...
          <!-- Icon -->
          <div class="relative after:absolute after:top-7 after:bottom-1 after:start-3 after:w-px after:-translate-x-[0.5px] after:bg-gray-300 dark:after:bg-neutral-600">
            <div class="relative z-10 size-6 flex justify-center items-center">
              <div class="size-2 rounded-full bg-gray-800 dark:bg-neutral-200"></div>
            </div>
          </div>
          <!-- End Icon -->
          ...
          <div class="grow pb-8 group-last:pb-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
              ...
              <div>
                <div class="size-full sm:size-56 lg:size-64 md:ms-auto bg-gray-100 rounded-xl dark:bg-neutral-800">
                  <img class="size-full object-cover rounded-xl" src="https://images.unsplash.com/photo-1671726805768-93b4c260766b?q=80&w=480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Timeline History Image">
                </div>
              </div>
              <!-- End Col -->
            </div>
          ...
          <div class="grow pb-8 group-last:pb-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
              <div>
                <div class="space-y-3">
                  <p class="text-gray-500 dark:text-neutral-500">
                    Q1: Development of the first version of Preline, featuring a small set of core components designed for responsive web design.
                  </p>

                  <p class="text-gray-500 dark:text-neutral-500">
                    Q3: Launch of Preline as an open-source project, introducing over 500 components and templates, along with detailed documentation.
                  </p>
                </div>
              </div>
              <!-- End Col -->
              ...
              <div>
                <div class="size-full sm:size-56 lg:size-64 md:ms-auto bg-gray-100 rounded-xl dark:bg-neutral-800">
                  <img class="size-full object-cover rounded-xl" src="https://images.unsplash.com/photo-1631203928521-bde1e727e8b7?q=80&w=480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Timeline History Image">
                </div>
              </div>
              <!-- End Col -->
            </div>
          ...
          <div class="grow pb-8 group-last:pb-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
              <div>
                <div class="space-y-3">
                  <p class="text-gray-500 dark:text-neutral-500">
                    Q2: Expansion of the library to include 750+ components, integration with frameworks like React and Vue, and release of a Figma design system for seamless workflows.
                  </p>

                  <p class="text-gray-500 dark:text-neutral-500">
                    Q4: Preline establishes a strong developer community, introduces custom web design services, and continues to enhance its offerings with new features and updates.
                  </p>
                </div>
              </div>
              <!-- End Col -->
              ...
              <div>
                <div class="size-full sm:size-56 lg:size-64 md:ms-auto bg-gray-100 rounded-xl dark:bg-neutral-800">
                  <img class="size-full object-cover rounded-xl" src="https://images.unsplash.com/photo-1646066490241-d386dbb63539?q=80&w=480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Timeline History Image">
                </div>
              </div>
              <!-- End Col -->
            </div>
      ...
      <div class="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="mb-8">
          <div class="flex flex-wrap justify-between items-center gap-2">
            ...
            <p>
              <a class="font-mono text-sm text-blue-600 underline underline-offset-2 hover:decoration-2 focus:outline-hidden focus:decoration-2 dark:hover:text-blue-500" href="#">
                We're hiring
              </a>
            </p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10">
          ...
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1720048171256-38c59a19fd37?q=80&w=160&h=160&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                    James Fisher
                  </span>
                </div>
                <div>
                  <span class="font-mono whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                    Founder
                  </span>
                </div>
              </div>
          ...
          <!-- Avatar -->
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1720048169575-b179e1a20dc2?q=80&w=160&h=160&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
          ...
          <!-- Avatar -->
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1719937206140-c4b208c78aa7?q=80&w=160&h=160&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
          ...
          <!-- Avatar -->
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1721333087252-e4cffc249d2d?q=80&w=160&h=160&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
          ...
          <!-- Avatar -->
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1541101767792-f9b2b1c4f127?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=3&w=160&h=160&q=80" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
          ...
          <!-- Avatar -->
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1601935111741-ae98b2b230b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2.5&w=160&h=160&q=80" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
          ...
          <!-- Avatar -->
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1570654639102-bdd95efeca7a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2.5&w=160&h=160&q=80" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
          ...
          <!-- Avatar -->
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1659482634023-2c4fda99ac0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2.5&w=160&h=160&q=80" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
          ...
          <!-- Avatar -->
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1679412330254-90cb240038c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2.5&w=160&h=160&q=80" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
          ...
          <!-- Avatar -->
          <div class="w-full flex items-center gap-x-3">
            <img class="shrink-0 size-9 rounded-full" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2.5&w=160&h=160&q=80" alt="Avatar">
            <div class="grow">
              <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-3">
                <div class="grow flex items-center text-sm text-gray-800 after:flex-1 after:border-t after:border-dashed after:border-gray-200 after:mx-2 dark:text-white dark:after:border-neutral-700">
                  <span class="font-medium whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
    ...
    <div class="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
      <div class="max-w-3xl mx-auto">
        <!-- Grid -->
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-5 lg:gap-10">
          <!-- Card -->
          <a class="p-3 sm:p-4 bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
            <div class="flex items-center gap-x-4">
              <span class="shrink-0 flex justify-center items-center size-10 bg-gray-800 text-white rounded-full dark:bg-neutral-200 dark:text-black">
                <svg class="shrink-0 size-5" width="48" height="50" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                ...
                <p class="text-sm text-gray-500 dark:text-neutral-500">
                  Follow us here - we post cool stuff
                </p>
              </div>
            </div>
          </a>
          ...
          <a class="p-3 sm:p-4 bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
            <div class="flex items-center gap-x-4">
              ...
              <div>
                ...
                <p class="text-sm text-gray-500 dark:text-neutral-500">
                  Follow us here - we share our story
                </p>
              </div>
            </div>
          </a>
    ...
    <!-- Clients -->
    <div class="max-w-6xl pb-10 pt-14 lg:py-20 px-4 sm:px-6 lg:px-8 mx-auto">
      <!-- Heading -->
      ...
      <!-- Grid -->
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 items-center gap-3">
        <!-- Brands -->
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="391" height="86" viewBox="0 0 391 86" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="296" height="86" viewBox="0 0 296 86" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="380" height="87" viewBox="0 0 380 87" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="376" height="86" viewBox="0 0 376 86" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="558" height="86" viewBox="0 0 558 86" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="345" height="86" viewBox="0 0 345 86" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="387" height="86" viewBox="0 0 387 86" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="356" height="86" viewBox="0 0 356 86" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="269" height="87" viewBox="0 0 269 87" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="349" height="87" viewBox="0 0 349 87" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="437" height="86" viewBox="0 0 437 86" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="h-20 flex shrink-0 flex-col justify-center items-center bg-white border border-gray-200 rounded-xl hover:bg-gray-100 hover:shadow-xs focus:outline-hidden focus:bg-gray-100 focus:shadow-xs dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700" href="#">
          <svg class="w-16 md:w-20 h-full object-contain text-gray-800 dark:text-neutral-200" width="350" height="87" viewBox="0 0 350 87" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.404053 19.8816L38.2857 0.258789L76.5756 19.8816L38.2857 39.5731L0.404053 19.8816ZM227.823 29.4221V28.955C227.823 22.4818 231.63 20.4131 238.042 20.8803V9.06851C222.68 8.13425 215.399 15.8085 215.399 28.955V29.4221H208.453V41.2339H215.399V77.0027H227.823V41.2339H242.116V77.0027H254.539V41.2339H264.758V29.4221H254.539V28.955C254.539 22.4818 258.281 20.4131 264.758 20.8803V9.06851C249.396 8.13425 242.116 15.8085 242.116 28.955V29.4221H227.823ZM140.991 42.3671C144.932 39.2306 147.336 34.7595 147.336 29.0204C147.336 17.8761 138.253 10.2685 126.831 10.2685H100.314V76.8681H128.968C140.657 76.8681 150.008 68.9934 150.008 57.5822C149.875 50.7086 146.401 45.4368 140.991 42.3671ZM126.898 22.6141C131.173 22.6141 134.112 25.7507 134.112 29.9549C134.112 34.159 131.039 37.2953 126.898 37.2953H113.606V22.6141H126.898ZM128.902 64.6558H113.606V48.9736H128.902C133.444 48.9736 136.716 52.3104 136.716 56.7814C136.716 61.3193 133.444 64.6558 128.902 64.6558ZM188.748 29.3533V55.0455C188.748 63.3204 184.206 66.8572 178.128 66.8572C172.517 66.8572 168.576 63.5206 168.576 57.0475V29.3533H156.153V58.5825C156.153 71.2616 164.101 78.2687 174.388 78.2687C180.867 78.2687 185.876 75.8663 188.681 71.5953V76.9339H201.105V29.3533H188.748ZM316.257 58.1832H279.921C281.725 64.4561 286.934 67.1255 293.413 67.1255C298.288 67.1255 302.163 65.1234 304.234 62.3874L314.252 68.0597C309.778 74.5328 302.564 78.2699 293.281 78.2699C277.115 78.2699 266.896 67.3258 266.896 53.1115C266.896 38.8974 277.181 27.9533 292.344 27.9533C306.571 27.9533 316.724 39.0976 316.724 53.1115C316.724 54.9801 316.523 56.5817 316.257 58.1832ZM292.344 39.0976C285.666 39.0976 281.123 42.6344 279.72 48.7073H304.301C302.765 41.8337 297.553 39.0976 292.344 39.0976ZM334.691 37.5636V29.3553H322.267V76.9359H334.691V54.1801C334.691 44.1702 342.841 41.3007 349.321 42.1015V28.4211C343.242 28.4211 337.163 31.0905 334.691 37.5636ZM38.2857 73.245L12.4418 59.2302L0.404053 65.737L38.2857 86.2588L76.5756 65.737L64.4017 59.2302L38.2857 73.245ZM12.4418 37.1159L38.2857 49.8253L64.4017 37.1159L76.5756 43.047L38.2857 61.6874L0.404053 43.047L12.4418 37.1159Z" fill="currentColor" />
          </svg>
        </a>
        <!-- End Brands -->
      </div>
