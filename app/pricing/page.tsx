...
export default function PricingPage() {
  ...
  <main id="content">
    <!-- Hero -->
    <div class="relative py-10 md:py-14 px-4 before:absolute before:inset-0 before:-z-1 before:mx-3 lg:before:mx-6 2xl:before:mx-10 before:bg-linear-to-b before:from-gray-100 before:to-transparent before:rounded-2xl dark:before:from-neutral-800">
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div class="flex flex-col">
                ...
                <ul class="mt-7 space-y-2.5 text-sm">
                  <li class="flex items-center gap-x-3">
                    <svg class="shrink-0 size-4 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="p-4 md:p-6 h-full flex flex-col bg-white border border-gray-200 rounded-xl shadow-xs dark:bg-neutral-900 dark:border-neutral-700">
              ...
              <header class="flex flex-col">
                <h4 class="font-semibold text-lg text-gray-800 dark:text-neutral-200">
                  Pro <span class="font-mono font-normal text-xs text-blue-600 dark:text-blue-500">&mdash; Most popular</span>
                </h4>
      ...
      <div class="max-w-2xl px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="p-4 bg-white border border-gray-200 rounded-xl dark:bg-neutral-900 dark:border-neutral-700">
          <div class="flex gap-x-4">
            <svg class="shrink-0 size-7 mt-1 text-blue-600 dark:text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="pt-14 lg:pt-24">
      <div class="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="relative">
          ...
          <!-- Header -->
          <div class="hidden lg:block sticky top-16 start-0 py-2 bg-white border-b border-gray-200 dark:bg-neutral-900 dark:border-neutral-700">
            <!-- Grid -->
          ...
          <div class="mt-6 space-y-4 lg:space-y-0">
            ...
            <ul class="grid lg:grid-cols-6 lg:gap-6">
              ...
              <!-- Item -->
              <li class="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-700">
            ...
            <ul class="grid lg:grid-cols-6 lg:gap-6">
              ...
              <li class="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-700">
                <div class="grid grid-cols-2 md:grid-cols-6 lg:block">
                  ...
                  <svg class="shrink-0 size-5 text-blue-600 dark:text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <polyline points="20 6 9 17 4 12" />
                  </svg>
                </div>
              </li>
          ...
          <div class="hidden lg:block mt-6">
            ...
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-1">
                <a class="py-2.5 px-3.5 w-full inline-flex justify-center items-center gap-x-1.5 whitespace-nowrap text-[13px] md:text-sm rounded-lg bg-white border border-gray-200 text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#">
                  Get started
                </a>
              </div>
              <!-- End Col -->
    ...
    <!-- Clients -->
    <div class="pb-10 pt-20 lg:pt-32">
      <div class="max-w-6xl px-4 sm:px-6 lg:px-8 mx-auto">
        <!-- Heading -->
