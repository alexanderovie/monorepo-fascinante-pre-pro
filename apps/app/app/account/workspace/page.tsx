 ...
 *
 * Página de workspace dentro del sistema de tabs de Account.
 * Basada en la plantilla Preline Pro account-workspace.html
 */
...
export default function AccountWorkspacePage() {
  return (
    <div>
      ...
      {/* Placeholder - TODO: Implementar configuración de workspace */}
      <div className="bg-white border border-gray-200 rounded-xl shadow-2xs p-6 dark:bg-neutral-800 dark:border-neutral-700">
        <p className="text-gray-600 dark:text-neutral-400">
          Configuración de workspace en desarrollo...
        </p>
      </div>
    </div>
  )
