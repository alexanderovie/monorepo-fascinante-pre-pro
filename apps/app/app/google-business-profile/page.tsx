/**
 * Google Business Profile - Overview Page
 *
 * Página de overview de Google Business Profile con todos los componentes del dashboard.
...
/**
 * Página protegida de overview de Google Business Profile.
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-900 relative">
      ...
      <main id="content" className="pt-15 pb-10 sm:pb-16">
        ...
        <div className="p-2 sm:p-5 sm:py-0 md:pt-5 space-y-5">
          ...
          <GBPDashboard initialData={await getGBPDashboardData()} />
