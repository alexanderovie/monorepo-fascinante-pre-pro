        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:items-center gap-y-6 md:gap-x-8 lg:gap-x-12">
          ...
          <div className="hs-accordion-outside-group relative h-96 md:h-150 w-full">
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 after:absolute after:inset-0 after:size-full after:z-1 after:rounded-xl after:bg-gradient-to-t after:from-blue-600 after:to-transparent">
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 after:absolute after:inset-0 after:size-full after:z-1 after:rounded-xl after:bg-gradient-to-t after:from-violet-600 after:to-transparent">
                <div className="p-4 md:p-6 relative z-10 flex flex-col justify-end gap-3">
                  <div>
                    <svg
                      className="shrink-0 w-auto h-6 md:h-8 text-white"
