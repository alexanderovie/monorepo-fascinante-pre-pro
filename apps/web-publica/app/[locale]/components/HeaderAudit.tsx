          ...
          <div className="flex items-center justify-between gap-x-4 w-full">
            ...
            <div className="flex items-center gap-x-2">
              ...
              <Link
                ...
                aria-label={t('login')}
              >
                {/* Icono de usuario - visible en todas las pantallas */}
                <svg
                  className="shrink-0 size-4 sm:size-4"
              ...
              >
                ...
                {/* Versión corta en móvil (hasta sm), versión larga desde sm */}
                <span className="sm:hidden">{t('requestCallShort')}</span>
                <span className="hidden sm:inline">{t('requestCall')}</span>
              </button>
            </div>
          </div>
        </nav>
